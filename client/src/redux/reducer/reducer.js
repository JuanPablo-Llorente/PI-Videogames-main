...
function rootReducer(state = initialSate, {type, payload})
{
    switch(type)
    {
        case GET_VIDEOGAMES:
            ...
            {
                alert("Sorry! We can not load videogames. Try again later.");
                return {...state};
            };
        ...
        case GET_VIDEOGAMES_BY_NAME:
            ...
            {
                alert("Sorry! We could not find the videogame. Check if it is well written.");
                return {...state};
            };
        ...
        case GET_GENRES:
            ...
            {
                alert("Sorry! We can not load the genres. Try again later.");
                return {...state};
            };
            ...
            case GET_PLATFORMS:
                ...
                {
                    alert("Sorry! We can not load the platforms. Try again later.");
                    return {...state};
                };
        ...
        case FILTER_BY_GENRE:
            ...
            {
                alert("Sorry! No videogames found.");
                return {...state};
            }
